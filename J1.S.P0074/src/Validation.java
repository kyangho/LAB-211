    ...
    public static Integer inputIntLimit(String message, int first, int end, boolean canNull) {
        ...
        while (true) {
            ...
            if (first <= input && input <= end) {
                ...
                if (first != end) {
                    System.err.printf("Enter a integer number from %d to %d!\n", first, end);
                } else {
                    System.err.printf("A integer valiable is %d!\n", first);
                }
            }
        }
    }
    ...
    public static int inputInt() {
        while (true) {
            ...
            try {
                ...
                System.out.print(ANSI_RED + "You must enter number, enter again: " + ANSI_RESET);
            }
        }
    }
        ...
        while (true) {
            ...
            try {
                ...
                if (Integer.parseInt(raw) == Integer.parseInt(raw) && num > 0) {
                    ...
                    System.out.print(ANSI_RED + "Size of matrix must bigger 0, enter again: " + ANSI_RESET);
                }
            } catch (Exception e) {
                System.out.print(ANSI_RED + "Size of matrix must bigger 0, enter again: " + ANSI_RESET);
            }
